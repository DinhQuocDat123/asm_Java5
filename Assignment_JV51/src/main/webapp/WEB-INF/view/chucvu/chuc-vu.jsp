...
<body>
<h3 style="color: red; text-align: center"><b>Chức Vụ</b></h3>
<hr>
    ...
    <table class="table table-bordered border-dark">
        ...
        <c:forEach items="${list}" var="cv">
            <tr>
                ...
                <td>${cv.ten}</td>
                <td>
                    <a href="/chuc-vu/detail-chuc-vu/${cv.id}" class="btn btn-outline-primary" tabindex="-1"
                       role="button">Detail</a>
                    <a href="/chuc-vu/remove-chuc-vu/${cv.id}" class="btn btn-outline-primary" tabindex="-1"
                       role="button" onclick="return checkRemove() ">Delete</a>
                    <a href="/chuc-vu/view-update-chuc-vu/${cv.id}" class="btn btn-outline-primary" tabindex="-1"
