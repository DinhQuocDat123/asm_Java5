...
<body>
<form:form action="/gio-hang-chi-tiet/update-gio-hang-chi-tiet/${gioHangChiTiet.id.gioHang.id}/${gioHangChiTiet.id.chiTietSanPham.id}" method="post" modelAttribute="gioHangChiTiet">
