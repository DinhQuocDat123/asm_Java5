...
<body>
<h3 style="color: red; text-align: center"><b>Sản Phẩm</b></h3>
<hr>
    ...
    <table class="table table-bordered border-dark">
        ...
        <c:forEach items="${listSanPham}" var="sp" varStatus="STT">
            <tr>
                ...
                <td>${sp.ten}</td>
                <td>
                    <a href="/san-pham/detail-san-pham/${sp.id}" class="btn btn-outline-primary" tabindex="-1"
                       role="button">Detail</a>
                    <a href="/san-pham/remove-san-pham/${sp.id}" class="btn btn-outline-primary" tabindex="-1"
                       role="button" onclick="return checkRemove() ">Delete</a>
                    <a href="/san-pham/view-update-san-pham/${sp.id}" class="btn btn-outline-primary" tabindex="-1"
