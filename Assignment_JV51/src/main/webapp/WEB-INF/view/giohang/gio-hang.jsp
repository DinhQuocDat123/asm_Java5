...
<h3 style="color: red; text-align: center"><b>Giỏ Hàng</b></h3>
<hr>
...
<form:form action="/gio-hang/add-gio-hang" method="post" modelAttribute="gioHang">
    <div class="row">
        <div class="col">
    ...
    <table class="table table-bordered border-dark">
        ...
        <c:forEach items="${list}" var="gh">
            <tr>
                ...
                <td>${gh.sdt}</td>
                <td>
                    <a href="/gio-hang/detail-gio-hang/${gh.id}"
                       class="btn btn-outline-primary" tabindex="-1"
                       role="button">Detail</a>
                    <a href="/gio-hang/remove-gio-hang/${gh.id}"
                       class="btn btn-outline-primary" tabindex="-1"
                       role="button" onclick="return checkRemove() ">Delete</a>
                    <a href="/gio-hang/view-update-gio-hang/${gh.id}"
