...
<h3 style="color: red; text-align: center"><b>Hoá Đơn Chi Tiết</b></h3>
<hr>
...
<form:form action="/hoa-don-chi-tiet/add-hoa-don-chi-tiet" method="post" modelAttribute="hoaDonChiTiet">
    ...
    <table class="table table-bordered border-dark">
        ...
        <c:forEach items="${list}" var="hdct">
            <tr>
                ...
                <td>${hdct.donGia}</td>
                <td>
                    <a href="/hoa-don-chi-tiet/detail-hoa-don-chi-tiet/${hdct.id.hoaDon.id}/${hdct.id.chiTietSanPham.id}"
                       class="btn btn-outline-primary" tabindex="-1"
                       role="button">Detail</a>
                    <a href="/hoa-don-chi-tiet/remove-hoa-don-chi-tiet/${hdct.id.hoaDon.id}/${hdct.id.chiTietSanPham.id}"
                       class="btn btn-outline-primary" tabindex="-1"
                       role="button">Delete</a>
                    <a href="/hoa-don-chi-tiet/view-update-hoa-don-chi-tiet/${hdct.id.hoaDon.id}/${hdct.id.chiTietSanPham.id}"
