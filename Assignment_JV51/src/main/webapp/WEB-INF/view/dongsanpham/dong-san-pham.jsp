...
<body>
<h3 style="color: red; text-align: center"><b>Dòng Sản Phẩm</b></h3>
<hr>
    ...
    <table class="table table-bordered border-dark">
        ...
        <c:forEach items="${list}" var="dsp">
            <tr>
                ...
                <td>${dsp.ten}</td>
                <td>
                    <a href="/dong-san-pham/detail-dong-san-pham/${dsp.id}" class="btn btn-outline-primary" tabindex="-1"
                       role="button">Detail</a>
                    <a href="/dong-san-pham/remove-dong-san-pham/${dsp.id}" class="btn btn-outline-primary" tabindex="-1"
                       role="button" onclick="return checkRemove() ">Delete</a>
                    <a href="/dong-san-pham/view-update-dong-san-pham/${dsp.id}" class="btn btn-outline-primary" tabindex="-1"
